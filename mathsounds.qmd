...
* [http://turner.faculty.swau.edu/mathematics/materialslibrary/pi/pibases.html](snippets of $\pi$ in various bases)
* [http://threesixty360.wordpress.com/2008/01/27/musical-pi-part-1/](musical $\pi$)
...
```{r}
play(mkseq(freq, 0.2), "play")
play(mkseq(440*c(pentatonic_scale, 2), 0.2), "play")
play(mkseq(440*c(ratios, 2), 0.2), "play")
play(mkseq(440*c(even_ratios, 2), 0.2), "play")
play(mkseq(440*rep(c(ratios["M3"], even_ratios["M3"]),5)), "play")
play(mkseq(rep(c(657, 660),5), duration = 0.5), "play")
```

See `prepComb` to get rid of clicks?
