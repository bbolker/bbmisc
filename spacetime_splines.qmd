...
An exponentially decaying (space/time) autocorrelation function corresponds to either (1) an Ornstein-Uhlenbeck process (in continuous space/time) with rate parameter $-\log\rho$ or scale parameter $-1/\log \rho$; (2) an AR1 process with correlation parameter $\rho$; (3) a Matérn process with shape $\nu = 1/2$.
