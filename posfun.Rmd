...
$$
f(x')  = \varepsilon \left(\sum_{i=0}^n (-1)^i \left(x'/\varepsilon\right)^i \right)
$$
...
(he doesn't necessarily take responsibility for the case statement/behaviour when $x < 0$).
