...
* if we have `rprocess` and `dmeasure` we can d

## sequential methods: particle filtering etc.
...
* "feature-based", "probe-matching"
* define some set of summary statistics that capture aspects of the outcome you care bout

## likelihood-free methods: ABC
