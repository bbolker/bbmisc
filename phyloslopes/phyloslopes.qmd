...
This tensor-product construction is actually more flexible than `mgcv`'s default approach, which would set $\bSigma_{\textrm{null}}$ to $\sigma_{T1}^2 \bI_2$. It is (surprisingly) hard to get either this approach or `mgcv`'s to reduce to the additive model ...
