...
`phyr` is much faster: median (n=100) = 13.5 ms, 5th/95th percentiles = 8.6 ms / 16.0 ms.
...
We'll do these first with a strictly linear effect of log-body-mass, then with a thin-plate-spline smooth.
...
## against small test matrices in phylo_tiny.R). tX below is built from
