...
Some thoughts on *large language models* (Gemini, ChatGPT, Microsoft Copilot, Claude, etc.). They are intended as a jumping-off point for class discussion.
...
## survey (2026 ISCI math version)

```{r qrcode, out.width = "90%"}
#| echo: false
library("qrcode")
plot(qr_code("https://docs.google.com/forms/d/e/1FAIpQLSc_QNgESEpQu-3yBVsARJUEWOOb6LVuZs5tdyd_iWTHdRXM1Q/viewform?usp=dialog"))
```
