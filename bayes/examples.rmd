...
$\hat R$ (`Rhat`), ESS look OK. @vehtariRankNormalization2021 recommend an $\hat R$ threshold of 1.01, ESS > 400
...
@vehtariRankNormalization2021 recommend *rank-histograms* instead: chains should have similar rank distributions
...
```r
post_df <- sleepstudy |> add_predicted_draws(b_reg)
ggplot(post_df,aes(Days, .prediction, group=interaction(Subject,.draw))) +
