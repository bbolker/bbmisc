...
hypothesis ($\sum_{j=1}^N \pr(D \cap H_j)$). The entire gray ellipse in the middle represents $\pr(D)$.
Each wedge (e.g. the hashed area $H_5$ ) represents an alternative hypothesis.
...
the data $D$ (ellipse) and the particular hypothesis $H_j$ (wedge).
